 ...
 */
package se.sics.kompics.manual.example3b;
...
/**
 * The <code>Host</code> class.
 * 
 * @author Jim Dowling <jdowling@sics.se>
 * @author Cosmin Arad <cosmin@sics.se>
 * @version $Id: Host.java 268 2008-09-28 19:18:04Z Cosmin $
 */
public class Host extends ComponentDefinition {

	Positive<PingPongPortReversed> posPingPong = positive(PingPongPortReversed.class);

	/**
	 * Instantiates a new host.
	 */
	public Host() {
		subscribe(handlePing, posPingPong);
	}
