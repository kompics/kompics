...
import se.sics.kompics.p2p.overlay.structured.chord.ChordAddress;
import se.sics.kompics.p2p.overlay.structured.chord.ring.NewPredecessor;
import se.sics.kompics.p2p.overlay.structured.chord.ring.NewSuccessorList;
