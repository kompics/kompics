...
public interface Constants {
	...
	public static final int LOCAL_XML_RPC_PORT_DEFAULT = 8088;
	
	public static final String LOCAL_XML_RPC_PORT = "XmlRpcPort";
	...
	public static final String PLC_API_ADDRESS = "PlcApiAddress";
}
