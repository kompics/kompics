 ...
 */
public class DownloadFileRequest extends CommandRequest {
	...
	public DownloadFileRequest(int sessionId, String remotePath, String localDir,  
			String patternMatch,
			String fileType,
			double timeout, boolean stopOnError) {
		super(sessionId, "#download " + remotePath + " " + localDir 
				+ " " + patternMatch + " " + fileType,  
				timeout, stopOnError);
