...
public class DaemonMain extends ComponentDefinition {
	...
	public DaemonMain() {
		...
		logger.info("Daemon listening on {}", Configuration.getPeer0Address());
		...
		DaemonInit dInit = new DaemonInit(DaemonConfiguration.getDaemonId(), DaemonConfiguration
				.getPeer0Address(), MasterAddressConfiguration.getMasterAddress(),
