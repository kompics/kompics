 ...
 * @version $Id$
 */
public final class NewPredecessor extends Event {

	private final ChordAddress localPeer;

	private final ChordAddress predecessorPeer;

	public NewPredecessor(ChordAddress localPeer, ChordAddress predecessorPeer) {
		super();
