...
/**
 * The <code>ChordPSInit</code> class.
 * 
...
public final class ChordPSInit extends Init {
	...
	public ChordPSInit(int log2RingSize,
			int successorListLength, long stabilizationPeriod, ChordAddress self) {
		super();
	...
	public final int getSuccessorListLength() {
		return successorListLength;
	}

	public final long getStabilizationPeriod() {
