...
/**
 * The <code>DescriptorBuffer</code> class represents a buffer of Cyclon node
...
public class DescriptorBuffer {
	...
	public DescriptorBuffer(CyclonAddress from,
	...
	/**
	 * @return the list of node descriptors in the buffer.
	 */
