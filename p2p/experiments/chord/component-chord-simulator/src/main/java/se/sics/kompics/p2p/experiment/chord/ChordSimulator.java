...
/**
 * The
 * <code>ChordSimulator</code> class.
 *
...
public final class ChordSimulator extends ComponentDefinition {
    ...
    public ChordSimulator(ChordSimulatorInit init) {
    ...
    /**
     * The
     * <code>WebRequestDestinationFilter</code> class.
     *
     * @author Cosmin Arad <cosmin@sics.se>
    ...
    private final Component createAndStartNewPeer(NumericRingKey nodeKey) {
        ...
        Component peer = create(ChordPeer.class, new ChordPeerInit(peerAddress, bootstrapConfiguration,
