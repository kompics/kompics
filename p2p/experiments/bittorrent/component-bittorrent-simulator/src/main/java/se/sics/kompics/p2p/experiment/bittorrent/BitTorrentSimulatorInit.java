...
/**
 * The <code>BitTorrentSimulatorInit</code> class.
 * 
 * @author Cosmin Arad <cosmin@sics.se>
 * @version $Id$
 */
public final class BitTorrentSimulatorInit extends Init {

	private final BitTorrentConfiguration btConfiguration;

	private final TorrentMetadata torrent;

	private boolean selfishPeers;

	public BitTorrentSimulatorInit(BitTorrentConfiguration btConfiguration,
			TorrentMetadata torrent, boolean selfishPeers) {
		super();
		this.btConfiguration = btConfiguration;
		this.torrent = torrent;
		this.selfishPeers = selfishPeers;
	}

	public BitTorrentConfiguration getBtConfiguration() {
