...
/**
 * The <code>BitTorrentSimulationMain</code> class.
 * 
...
public final class BitTorrentSimulationMain extends ComponentDefinition {
	...
	public BitTorrentSimulationMain() throws IOException {
		...
		Component btTracker = create(BitTorrentTracker.class);
		Component btSimulator = create(BitTorrentSimulator.class);
		...
		trigger(new BitTorrentTrackerInit(torrentMetadata.getTracker()),
				btTracker.getControl());
		trigger(new BitTorrentSimulatorInit(btConfiguration, torrentMetadata,
				btConfiguration.isSelfishPeers()), btSimulator.getControl());
