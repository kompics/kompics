...
/**
 * The <code>CyclonPeerJoin</code> class is an event that instructs the
 * <code>CyclonSimulator</code> to join a new peer.
 * 
...
public final class CyclonPeerJoin extends Event {
	...
	public CyclonPeerJoin(BigInteger cyclonId) {
