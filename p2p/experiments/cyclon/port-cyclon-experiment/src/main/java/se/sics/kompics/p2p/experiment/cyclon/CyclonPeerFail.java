...
/**
 * The <code>CyclonPeerFail</code> class is an event that instructs the
 * <code>CyclonSimulator</code> to fail an existing peer.
 * 
...
public final class CyclonPeerFail extends Event {
	...
	public CyclonPeerFail(BigInteger cyclonId) {
