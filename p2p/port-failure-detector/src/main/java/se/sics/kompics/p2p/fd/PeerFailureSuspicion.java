 ...
 * @version $Id$
 */
public final class PeerFailureSuspicion extends Response {
	...
	public PeerFailureSuspicion(StartProbingPeer request, Address peerAddress,
			OverlayAddress overlayAddress, SuspicionStatus suspicionStatus) {
		super(request);
	...
	public final SuspicionStatus getSuspicionStatus() {
