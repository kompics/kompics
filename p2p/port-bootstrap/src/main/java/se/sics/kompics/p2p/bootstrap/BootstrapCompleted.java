...
/**
 * The <code>BootstrapCompleted</code> class.
 * 
 * @author Cosmin Arad <cosmin@sics.se>
 * @version $Id$
 */
public final class BootstrapCompleted extends Event {

	private final String overlay;

	private final OverlayAddress overlayAddress;

	public BootstrapCompleted(String overlay, OverlayAddress overlayAddress) {
		super();
