...
/**
 * The <code>BitTorrentPeer</code> class.
 * 
...
public class BitTorrentClient extends ComponentDefinition {
	...
	Handler<BitTorrentClientInit> handleInit = new Handler<BitTorrentClientInit>() {
		public void handle(BitTorrentClientInit init) {
			self = init.getSelf();
	 ...
	 * is available at the <code>peer</code> node.
	 * 
	 * @param peer
	 ...
	 * 
	 * @param regularRound
	 *            is <code>true</code> when algorithm is called periodically and
	 *            <code>false</code> when called as a result of change of peer
	 *            interest
	 */
