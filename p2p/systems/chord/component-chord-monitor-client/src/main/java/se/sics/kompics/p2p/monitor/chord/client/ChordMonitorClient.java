...
/**
 * The <code>ChordMonitorClient</code> class.
 * 
...
public class ChordMonitorClient extends ComponentDefinition {
	...
	private Handler<ChordMonitorClientInit> handleInit = new Handler<ChordMonitorClientInit>() {
		public void handle(ChordMonitorClientInit event) {
			self = event.getSelf();
