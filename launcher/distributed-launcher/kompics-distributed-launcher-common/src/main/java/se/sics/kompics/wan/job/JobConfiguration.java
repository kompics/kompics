...
//	private P2pMonitorConfiguration monitorConfiguration;
	...
	public JobConfiguration(int daemonId, int networkPort, int webPort) {
		...
		webAddress = "http://" + ip.getHostAddress() + ":" + webPort + "/";
                ...
                JettyWebServerConfiguration jettyConfig = new
                        JettyWebServerConfiguration(ip, webPort,webRequestTimeout, webThreads, homePage);
		jettyWebServerInit = new JettyWebServerInit(jettyConfig);
