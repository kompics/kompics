...
public final class CollectionsX {
     ...
     */
    public static <E> ObservableList<E> observableList(CopyOnWriteArrayList<E> list) {
     ...
     */
    public static <E> ObservableListHelper<E> observableListHelper(CopyOnWriteArrayList<E> list) {
    ...
    private static final class ObservableListImpl<E> extends CopyOnWriteArrayList<E>
//            AbstractList<E>
        ...
        ObservableListImpl(CopyOnWriteArrayList<E> list, boolean supportsElementPropertyChanged) {
            this.list = list;
