...
public abstract class BaseHandler<M> extends SimpleChannelInboundHandler<M> {
    ...
    public void channelActive(ChannelHandlerContext ctx) {
        ...
        try {
            component.extLog.trace("Channel connected: {} {} => {} ({})", new Object[] { protocol,
                    ctx.channel().localAddress(), ctx.channel().remoteAddress(), ctx.channel() });
        } finally {
            MDC.clear();
        }
    }
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
        ...
        try {
            ...
            if (address != null && address instanceof InetSocketAddress) {
                ...
                component.networkException(
                        new NetworkException("Error in Channel handler to " + addr, addr, protocol, cause));
            }
