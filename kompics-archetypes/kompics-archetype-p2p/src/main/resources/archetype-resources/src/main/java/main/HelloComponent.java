 ...
 */
public final class HelloComponent extends ComponentDefinition {

	private static final Logger logger = LoggerFactory
	.getLogger(HelloComponent.class);
	...
	private Handler<Start> handleStart = new Handler<Start>() {
		public void handle(Start event) {
			logger.info("HelloComponent started. Waiting for Commands.");
		}
	};  

	private Handler<HelloComponentInit> handleInit = new Handler<HelloComponentInit>() {
		public void handle(HelloComponentInit event) {
			self = event.getSelf();
